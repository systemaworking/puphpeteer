 ...
 * @method \Nesk\Puphpeteer\Resources\EventEmitter on(mixed $eventName, callable(mixed $event): void $handler)
 * @method \Nesk\Puphpeteer\Resources\EventEmitter once(mixed $eventName, callable(mixed $event): void $handler)
 * @method \Nesk\Puphpeteer\Resources\EventEmitter off(mixed $eventName, callable(mixed $event): void $handler)
 ...
 * @method \Nesk\Puphpeteer\Resources\ElementHandle addScriptTag(array{ url: string, path: string, content: string, type: string, id: string } $options)
 * @method \Nesk\Puphpeteer\Resources\ElementHandle addStyleTag(array{ url: string, path: string, content: string } $options)
 * @method void exposeFunction(string $name, callable|array{ default: callable } $puppeteerFunction)
 ...
 * @method \Nesk\Puphpeteer\Resources\HTTPResponse|null goto(string $url, array<string, mixed>&array{ referer: string } $options = null)
 ...
 * @method \Nesk\Puphpeteer\Resources\HTTPRequest waitForRequest(string|callable(callable(\Nesk\Puphpeteer\Resources\HTTPRequest $req): bool|Promise<bool>):  $urlOrPredicate, array{ timeout: float } $options = null)
 * @method \Nesk\Puphpeteer\Resources\HTTPResponse waitForResponse(string|callable(callable(\Nesk\Puphpeteer\Resources\HTTPResponse $res): bool|Promise<bool>):  $urlOrPredicate, array{ timeout: float } $options = null)
 * @method void waitForNetworkIdle(array{ idleTime: float, timeout: float } $options = null)
 * @method \Nesk\Puphpeteer\Resources\Frame waitForFrame(string|callable(callable(\Nesk\Puphpeteer\Resources\Frame $frame): bool|Promise<bool>):  $urlOrPredicate, array{ timeout: float } $options = null)
 ...
 * @method mixed|string screenshot(array<string, mixed> $options = null)
 * @method mixed createPDFStream(array<string, mixed> $options = null)
 ...
 * @method \Nesk\Puphpeteer\Resources\JSHandle|null waitFor(string|float|callable $selectorOrFunctionOrTimeout, array{ visible: bool, hidden: bool, timeout: float, polling: string|float } $options = null, int|float|string|bool|null|array|\Nesk\Puphpeteer\Resources\JSHandle ...$args)
